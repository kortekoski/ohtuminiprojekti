...
class TestAddReference(unittest.TestCase):
    ...
    def test_cannot_add_wrong_value_types(self):
        ref1 = Reference(
            None, "string", "Bad Dude", "all out of gum", "book"
        )
        ref2 = Reference(
            None, 2001, 1, "all out of gum", "book"
        )
        ref3 = Reference(
            None, 2001, "Bad Dude", 1, "book"
        )
        ref4 = Reference(
            None, 2001, "Bad Dude", "all out of gum", 1
        )
    ...
    def test_create_reference_appears_on_index(self):
        ...
        self.client.post('/create_reference', data={
            'year': '2001',
            'author': 'Bad Dude',
            'title': 'all out of gum',
            'reftype': 'book'

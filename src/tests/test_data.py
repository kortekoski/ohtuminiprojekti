...
class TestData:
    ...
    @staticmethod
    def valid_reference():
        return Reference(None, "Test2024", 2001, "Bad Dude", "all out of gum", "book")
    ...
    def invalid_bibtex_type():
        return Reference(None, "Test2024", 2001, "Bad Dude", "all out of gum", "value")
    ...
    def invalid_author_references():
        return [
            ...
            Reference(None, "Test2026", 2001, "dude, bad", "all out of gum", "book"),
            Reference(None, "Test2027", 2001, "Bad Dude1", "all out of gum", "book"),
        ]

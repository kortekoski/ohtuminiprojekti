...
class TestReferenceValidation(unittest.TestCase):
    ...
    def test_incomplete_reference_is_invalid(self):
        ...
        test_ref2 = {RefField.YEAR.value: 2004, RefField.AUTHOR.value: "big name author", RefField.REFTYPE.value: "book"}
        test_ref3 = {RefField.YEAR.value: 2004, RefField.TITLE.value: "really cool title", RefField.REFTYPE.value: "book"}
        test_ref4 = {
            "year": 2004,
